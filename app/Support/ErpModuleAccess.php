...
final class ErpModuleAccess
{
    ...
    private const MODULES = [
        ...
        'franchisee_purchases' => [
            'label' => 'Franchisee Outside Purchases',
            'category' => 'Procurement',
            'description' => 'Track and approve franchisee purchases from external vendors.',
        ],
        'stock_adjustment' => [
        ...
        'email_templates' => [
            ...
            'category' => 'Communication',
            'description' => 'Manage reusable operational email templates.',
        ],
        'ledger' => [
    ...
    private static function routeRequirements(): array
    {
        return [
            ...
            'admin.purchase-orders.' => ['module' => 'purchase_orders', 'action' => 'view'],
            'admin.purchase-invoices.' => ['module' => 'purchase_invoices', 'action' => 'view'],
            'admin.purchase-returns.' => ['module' => 'purchase_returns', 'action' => 'view'],
            'admin.franchisee-purchases.' => ['module' => 'franchisee_purchases', 'action' => 'view'],
            'admin.stock.adjust' => ['module' => 'stock_adjustment', 'action' => 'view'],
            'admin.stock-alerts.' => ['module' => 'stock_adjustment', 'action' => 'view'],
            ...
            'admin.email-templates.' => ['module' => 'email_templates', 'action' => 'view'],
            ...
            'reports.compliance.' => ['module' => 'reports_gst', 'action' => 'view'],
